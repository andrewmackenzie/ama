...
struct Setup: ParsableCommand {
    ...
    func run() throws {
        ...
        print("============")
        print()
        print("Ama needs two permissions:")
        ...
        print()
        print("These attach to your terminal app (Terminal/iTerm/Ghostty/etc.), not ama itself.")
        print()
        ...
        print()
        print("✓ all set. Run `ama` to start the daemon.")
    }
    ...
    private func waitForAccessibility() throws {
        ...
        print("  2. Re-run `ama setup` — macOS only picks up the grant on a fresh process.")
        throw ExitCode(0)
    }
    ...
    private func waitForMicrophone() throws {
        ...
        case .denied, .restricted:
            ...
            print("  enable your terminal, then re-run `ama setup`.")
            throw ExitCode(1)
        case .notDetermined:
